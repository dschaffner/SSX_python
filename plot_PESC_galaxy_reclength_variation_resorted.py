...
timestep_arr = [500,550,600,650,700,750,800,850,900,950,1000,1050,1100,1150,1200,1250,1300,1350,1400,1450,1500,1550,1600,1650,1700,1750,1800,1850,1900,1950,2000,2050,2100,2150,2200,2250,2300,2350,2400,2450,2500,2750,3000,3100,3200,3300,3400,3500,3600,3700,3800,3900,4000]
...
#CR7 -> 42
#CR8 -> 53
PEs_32 = np.zeros([53,500])
SCs_32 = np.zeros([53,500])
for file in np.arange(len(timestep_arr)):
    #fileheader = 'PE_SC_Type_32_6CR_3000_Rg_499_delays_4318orbits_'+str(timestep_arr[file])+'_timesteps'
    #fileheader = 'PE_SC_Type_32_4CR_3000_Rg_499_delays_7324orbits_'+str(timestep_arr[file])+'_timesteps'
    fileheader = 'PE_SC_Type_32_8CR_4000_Rg_499_delays_2870orbits_'+str(timestep_arr[file])+'_timesteps'
    #fileheader = 'PE_SC_Type_32_7CR_3000_Rg_499_delays_6058orbits_'+str(timestep_arr[file])+'_timesteps'
