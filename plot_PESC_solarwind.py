...
fileheader = 'PE_SC_ClusterChen_embeddelay5_46_delays'
...
bx_PE = datafile['PEsbx']
by_PE = datafile['PEsby']
bz_PE = datafile['PEsbz']
bx_SC = datafile['SCsbx']
by_SC = datafile['SCsby']
bz_SC = datafile['SCsbz']
