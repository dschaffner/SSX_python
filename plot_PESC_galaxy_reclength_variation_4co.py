...
timestep_arr = [500,700,900,1000,1200,1300,1400,1500,1800,2000,2500,3000]#,950,1000,1050,1100,1150,1200,1250,1300,1350,1400,1600,1800,2000,3000,4000,6000,8000]#,1450,1500,1550,1600,1650,1700,1750,1800,1850,1900,1950,2000]
...
for file in np.arange(len(timestep_arr)):
    ...
    fileheader = 'PE_SC_IDdatabase_Type_32_4co_data_3000_499_delays_5000orbits_'+str(timestep_arr[file])+'_timesteps'
...
PEs_noise = np.zeros([500])
SCs_noise = np.zeros([500])
fileheader = 'PE_SC_noise_data_8000_499_delays_1000orbits_8000_timesteps'
datafile = loadnpzfile(datadir+fileheader+npy)
...
plt.plot(timeindex[:SCs_32_1300_endarray-1],SCs_32[5,1:SCs_32_1300_endarray],color=colors[5,:],label='1300 timesteps')
plt.plot(timeindex[:SCs_32_1400_endarray-1],SCs_32[6,1:SCs_32_1400_endarray],color=colors[6,:],label='1400 timesteps')
...
plt.plot(timeindex[:SCs_32_1800_endarray-1],SCs_32[8,1:SCs_32_1800_endarray],color=colors[8,:],label='1800 timesteps')
plt.plot(timeindex[:SCs_32_2000_endarray-1],SCs_32[9,1:SCs_32_2000_endarray],color=colors[9,:],label='2000 timesteps')
plt.plot(timeindex[:SCs_32_2500_endarray-1],SCs_32[10,1:SCs_32_2500_endarray],color=colors[10,:],label='2500 timesteps')
plt.plot(timeindex[:SCs_32_3000_endarray-1],SCs_32[11,1:SCs_32_3000_endarray],color=colors[11,:],label='3000 timesteps')
#plt.plot(timeindex[:SCs_32_6000_endarray-1],SCs_32[24,1:SCs_32_6000_endarray],color=colors[24,:],label='6000 timesteps')
...
savefilename='SC_recordlengthvariation_type32_3000steps_4co_500to3000.png'
