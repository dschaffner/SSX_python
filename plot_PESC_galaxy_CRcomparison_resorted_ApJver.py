...
timeindex_normM4=timeindex/(M4dyn/10)
timeindex_normM5=timeindex/(M5dyn/10)
timeindex_normM6=timeindex/(M6dyn/10)
timeindex_normM7=timeindex/(M7dyn/10)
timeindex_normM8=timeindex/(M8dyn/10)
timeindex_normM9=timeindex/(M9dyn/10)
timeindex_normM10=timeindex/(M10dyn/10)
...
plt.plot(timeindex_normM4[:SCsCR4_endarray-1],SCsCR4[1:SCsCR4_endarray],marker=points[1],markevery=50,linestyle='dashed',color='blue',label='M4:'+str(orbitdur1)+r' $\tau_{dyn}^{M4}$')
plt.plot(timeindex_normM5,SCsCR5[1:],marker=points[1],markevery=50,color='red',linestyle='solid',label='M5:'+str(orbitdur2)+r' $\tau_{dyn}^{M5}$')
plt.plot(timeindex_normM6,SCsCR6[1:],marker=points[1],markevery=50,color='green',linestyle='dotted',label='M6:'+str(orbitdur3)+r' $\tau_{dyn}^{M6}$')
plt.plot(timeindex_normM7,SCsCR7[1:],marker=points[1],markevery=50,color='orange',linestyle='-.',label='M7:'+str(orbitdur4)+r' $\tau_{dyn}^{M7}$')
plt.plot(timeindex_normM8,SCsCR8[1:],marker=points[1],markevery=50,color='purple',linestyle='-.',label='M8:'+str(orbitdur5)+r' $\tau_{dyn}^{M8}$')
plt.plot(timeindex_normM9,SCsCR9[1:],marker=points[1],markevery=50,color='teal',linestyle='-.',label='M9:'+str(orbitdur6)+r' $\tau_{dyn}^{M9}$')
plt.plot(timeindex_normM10,SCsCR10[1:],marker=points[1],markevery=50,color='black',linestyle='-.',label='M10:'+str(orbitdur7)+r' $\tau_{dyn}^{M10}$')
...
plt.plot(timeindex_normM7,PEsCR7[1:],marker=points[1],markevery=50,color='orange',linestyle='-.',label='M7')
plt.plot(timeindex_normM8,PEsCR8[1:],marker=points[1],markevery=50,color='purple',linestyle='-.',label='M8')
plt.plot(timeindex_normM9,PEsCR9[1:],marker=points[1],markevery=50,color='teal',linestyle='-.',label='M9')
plt.plot(timeindex_normM10,PEsCR10[1:],marker=points[1],markevery=50,color='black',linestyle='-.',label='M10')
...
#timelist = list(timearray.astype(int))
plt.xticks(fontsize=12)
plt.xlabel(r'$\tau_s/\tau_{dyn}$',fontsize=15)
#ax1.set_xticklabels([])
...
leg=plt.legend(loc='lower right',fontsize=9,frameon=False,handlelength=5,numpoints=5)
...
#savefilename='SC_and_PE_CRscan_peakcomplexitysignature_et_dyntimenorm.png'
savefilename='SC_and_PE_CRscan_peakcomplexitysignature_et_dyntimenorm_ApJver.eps'
...
plt.ylabel(r'$\tau_s^{max}/\tau_{dyn}$',fontsize=15)
plt.ylim(0,0.1)
plt.text(0.07,0.92,'(a)',horizontalalignment='center',verticalalignment='center',transform=ax1.transAxes,fontsize=16)
...
plt.plot(CRs,ODminsnorm,'o',color='blue',label=r'$T_{D}/\tau_{dyn}$')
plt.plot(CRs,trap_periods/2.0,'^',color='red',label=r'$\frac{1}{2}T_{trap}/\tau_{dyn}$')
...
plt.ylabel(r'Fraction of $\tau_{dyn}$',fontsize=15)
plt.ylim(0,2.2)
...
#savefilename='Peaks_OD_ratio_vs_CR_resorted_ApJver.png'
