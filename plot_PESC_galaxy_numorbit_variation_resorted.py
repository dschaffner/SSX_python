...
numorbit_arr = [1,10,100,1000,2000]
...
#CR7 -> 42
#CR8 -> 53
PEs_32 = np.zeros([6,500])
SCs_32 = np.zeros([6,500])
for file in np.arange(len(numorbit_arr)):
    fileheader = 'PE_SC_Type_1_6CR_3000_Rg_499_delays_'+str(numorbit_arr[file])+'orbits_2000_timesteps_randorbits1'
...
datafile = loadnpzfile(datadir+fileheader+npy)
PEs_32[5,:]=datafile['PEs']
SCs_32[5,:]=datafile['SCs']
...
#fileheader = 'Binned_100_PE_SC_Type_32_6CR_3000_Rg_499_delays_4318orbits_of8834_total2000_timesteps_resorted'
...
datafiletest = loadnpzfile(datadir+fileheader+npy)
...
plt.plot(timeindex,SCs_32[0,:],color='blue',label='1 orbit')
plt.plot(timeindex,SCs_32[1,:],color='purple',label='10 orbits')
plt.plot(timeindex,SCs_32[2,:],color='green',label='100 orbits')
plt.plot(timeindex,SCs_32[3,:],color='orange',label='1000 orbits')
plt.plot(timeindex,SCs_32[4,:],color='red',label='2000 orbits')
plt.plot(timeindex,SCs_32[5,:],color='black',label='4318 orbits')
...
#plt.xlim(1,499)
plt.ylim(0.15,0.5)
leg=plt.legend(loc='upper left',fontsize=3,frameon=False,handlelength=5)
leg.set_title('Analysis Length',prop={'size':5})

savefilename='SC_numorbitvariation_type1_2000steps_6co.png'
