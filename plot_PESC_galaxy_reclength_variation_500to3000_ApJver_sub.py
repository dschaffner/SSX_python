...
plt.plot(normtimeindex[:SCs_32_750_endarray-1],SCs_32[1,1:SCs_32_750_endarray],color=colors[0,:],linestyle='solid',markevery=(20,100),label=str(orbitdur1)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_1000_endarray-1],SCs_32[2,1:SCs_32_1000_endarray],color=colors[1,:],linestyle='solid',label=str(orbitdur2)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_1676_endarray-1],SCs_32[13,1:SCs_32_1676_endarray],color=colors[2,:],linestyle='solid',label=str(orbitdur3)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_2000_endarray-1],SCs_32[18,1:SCs_32_2000_endarray],color=colors[3,:],linestyle='solid',label=str(orbitdur4)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_3352_endarray-1],SCs_32[23,1:SCs_32_3352_endarray],color=colors[4,:],linestyle='solid',label=str(orbitdur5)+r' $T_{dyn}^{M6}$')
...
plt.plot(normtimeindex[:SCs_32_750_endarray-1],PEs_32[1,1:SCs_32_750_endarray],color=colors[0,:],linestyle='solid',label=str(orbitdur1)+r' $T^{M6e}_{dyn}$')
plt.plot(normtimeindex[:SCs_32_1000_endarray-1],PEs_32[2,1:SCs_32_1000_endarray],color=colors[1,:],linestyle='solid',label=str(orbitdur2)+r' $T^{M6e}_{dyn}$')
plt.plot(normtimeindex[:SCs_32_1676_endarray-1],PEs_32[13,1:SCs_32_1676_endarray],color=colors[2,:],linestyle='solid',label=str(orbitdur3)+r' $T^{M6e}_{dyn}$')
plt.plot(normtimeindex[:SCs_32_2000_endarray-1],PEs_32[18,1:SCs_32_2000_endarray],color=colors[3,:],linestyle='solid',label=str(orbitdur4)+r' $T^{M6e}_{dyn}$')
plt.plot(normtimeindex[:SCs_32_3352_endarray-1],PEs_32[23,1:SCs_32_3352_endarray],color=colors[4,:],linestyle='solid',label=str(orbitdur5)+r' $T^{M6e}_{dyn}$')
...
plt.xlabel(r'$\tau_s/T^{M6e}_{dyn}$',fontsize=xaxis_label_fontsize)
...
#savefilename='SC_and_PE_recordlengthvariation_M6_type32i_normdyntime_ApJver_newcolor.png'
...
ax1=plt.subplot(2,1,1)
plt.plot(normtimeindex[:SCs_1_750_endarray-1],SCs_1[0,1:SCs_1_750_endarray],color=colors[0,:],linestyle='solid',markevery=(20,100),label=str(orbitdur1)+r' $T_{dyn}^{M6e}$')
plt.plot(normtimeindex[:SCs_1_1000_endarray-1],SCs_1[1,1:SCs_1_1000_endarray],color=colors[1,:],linestyle='solid',label=str(orbitdur2)+r' $T_{dyn}^{M6e}$')
plt.plot(normtimeindex[:SCs_1_1676_endarray-1],SCs_1[2,1:SCs_1_1676_endarray],color=colors[2,:],linestyle='solid',label=str(orbitdur3)+r' $T_{dyn}^{M6e}$')
plt.plot(normtimeindex[:SCs_1_2000_endarray-1],SCs_1[3,1:SCs_1_2000_endarray],color=colors[3,:],linestyle='solid',label=str(orbitdur4)+r' $T_{dyn}^{M6e}$')
plt.plot(normtimeindex[:SCs_1_3352_endarray-1],SCs_1[4,1:SCs_1_3352_endarray],color=colors[4,:],linestyle='solid',label=str(orbitdur5)+r' $T_{dyn}^{M6e}$')
...
ax2=plt.subplot(2,1,2)
#plt.plot(timeindex[:SCs_32_500_endarray-1],PEs_32[0,1:SCs_32_500_endarray],color=colors[0,:],label='50 Myr')
plt.plot(normtimeindex[:SCs_1_750_endarray-1],PEs_1[0,1:SCs_1_750_endarray],color=colors[0,:],linestyle='solid',label=str(orbitdur1)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1000_endarray-1],PEs_1[1,1:SCs_1_1000_endarray],color=colors[1,:],linestyle='solid',label=str(orbitdur2)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1676_endarray-1],PEs_1[2,1:SCs_1_1676_endarray],color=colors[2,:],linestyle='solid',label=str(orbitdur3)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_2000_endarray-1],PEs_1[3,1:SCs_1_2000_endarray],color=colors[3,:],linestyle='solid',label=str(orbitdur4)+r' $T_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_3352_endarray-1],PEs_1[4,1:SCs_1_3352_endarray],color=colors[4,:],linestyle='solid',label=str(orbitdur5)+r' $T_{dyn}^{M6}$')
