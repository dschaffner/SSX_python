...
#timestep_arr = [500,750,1000,1300,1350,1400,1450,1500,1550,1600,1650,1676,1700,1750,1800,1850,1900,1950,2000,2050,
#                2100,2150,2200,2500,3352]#,2350,2400,2450,2500,2750,3000,3100,3200,3300,3400,3500,3600,3700,3800,3900,4000]
...
SCs_32_2000_endarray=0#np.where(SCs_32[18,1:]==0)[0][0]
SCs_32_2050_endarray=0#np.where(SCs_32[18,1:]==0)[0][0]
SCs_32_2100_endarray=0#np.where(SCs_32[19,1:]==0)[0][0]
SCs_32_2150_endarray=0#np.where(SCs_32[20,1:]==0)[0][0]
SCs_32_2200_endarray=0#np.where(SCs_32[21,1:]==0)[0][0]
SCs_32_2500_endarray=0#np.where(SCs_32[22,1:]==0)[0][0]
SCs_32_3352_endarray=0#np.where(SCs_32[23,1:]==0)[0][0]


ax1=plt.subplot(1,1,1)
plt.plot(timeindex[:SCs_32_500_endarray-1],SCs_32[0,1:SCs_32_500_endarray],color=colors[0,:],label='500 timesteps')
plt.plot(timeindex[:SCs_32_750_endarray-1],SCs_32[1,1:SCs_32_750_endarray],color=colors[1,:],label='750 timesteps')
plt.plot(timeindex[:SCs_32_1000_endarray-1],SCs_32[2,1:SCs_32_1000_endarray],color=colors[2,:],label='1000 timesteps')
plt.plot(timeindex[:SCs_32_1300_endarray-1],SCs_32[3,1:SCs_32_1300_endarray],color=colors[3,:],label='1300 timesteps')
plt.plot(timeindex[:SCs_32_1350_endarray-1],SCs_32[4,1:SCs_32_1350_endarray],color=colors[4,:],label='1350 timesteps')
plt.plot(timeindex[:SCs_32_1400_endarray-1],SCs_32[5,1:SCs_32_1400_endarray],color=colors[5,:],label='1400 timesteps')
plt.plot(timeindex[:SCs_32_1450_endarray-1],SCs_32[6,1:SCs_32_1450_endarray],color=colors[6,:],label='1450 timesteps')
plt.plot(timeindex[:SCs_32_1500_endarray-1],SCs_32[7,1:SCs_32_1500_endarray],color=colors[7,:],label='1500 timesteps')
plt.plot(timeindex[:SCs_32_1550_endarray-1],SCs_32[8,1:SCs_32_1550_endarray],color=colors[8,:],label='1550 timesteps')
plt.plot(timeindex[:SCs_32_1600_endarray-1],SCs_32[9,1:SCs_32_1600_endarray],color=colors[9,:],label='1600 timesteps')
plt.plot(timeindex[:SCs_32_1650_endarray-1],SCs_32[10,1:SCs_32_1650_endarray],color=colors[10,:],label='1650 timesteps')
plt.plot(timeindex[:SCs_32_1676_endarray-1],SCs_32[11,1:SCs_32_1676_endarray],color=colors[11,:],label='1676 timesteps')
plt.plot(timeindex[:SCs_32_1700_endarray-1],SCs_32[12,1:SCs_32_1700_endarray],color=colors[12,:],label='1700 timesteps')
plt.plot(timeindex[:SCs_32_1750_endarray-1],SCs_32[13,1:SCs_32_1750_endarray],color=colors[13,:],label='1750 timesteps')
plt.plot(timeindex[:SCs_32_1800_endarray-1],SCs_32[14,1:SCs_32_1800_endarray],color=colors[14,:],label='1800 timesteps')
plt.plot(timeindex[:SCs_32_1850_endarray-1],SCs_32[15,1:SCs_32_1850_endarray],color=colors[15,:],label='1850 timesteps')
plt.plot(timeindex[:SCs_32_1900_endarray-1],SCs_32[16,1:SCs_32_1900_endarray],color=colors[16,:],label='1900 timesteps')
plt.plot(timeindex[:SCs_32_1950_endarray-1],SCs_32[17,1:SCs_32_1950_endarray],color=colors[17,:],label='1950 timesteps')
plt.plot(timeindex[:SCs_32_2000_endarray-2],SCs_32[18,1:SCs_32_2000_endarray-1],color=colors[18,:],label='2000 timesteps')
plt.plot(timeindex[:SCs_32_2050_endarray-2],SCs_32[19,1:SCs_32_2050_endarray-1],color=colors[19,:],label='2050 timesteps')
plt.plot(timeindex[:SCs_32_2100_endarray-2],SCs_32[20,1:SCs_32_2100_endarray-1],color=colors[20,:],label='2100 timesteps')
plt.plot(timeindex[:SCs_32_2150_endarray-2],SCs_32[21,1:SCs_32_2150_endarray-1],color=colors[21,:],label='2150 timesteps')
plt.plot(timeindex[:SCs_32_2200_endarray-2],SCs_32[22,1:SCs_32_2200_endarray-1],color=colors[22,:],label='2200 timesteps')
plt.plot(timeindex[:SCs_32_2500_endarray-2],SCs_32[23,1:SCs_32_2500_endarray-1],color=colors[23,:],label='2500 timesteps')
plt.plot(timeindex[:SCs_32_3352_endarray-2],SCs_32[24,1:SCs_32_3352_endarray-1],color=colors[24,:],label='3352 timesteps')
...
savefilename='M6_SC_recordlengthvariation_type32i_et.png'
