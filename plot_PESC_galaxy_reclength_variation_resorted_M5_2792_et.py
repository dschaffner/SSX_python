...
datadir = 'C:\\Users\\dschaffner\\Dropbox\\From OneDrive\\Galatic Dynamics Data\\GalpyData_July2018\\resorted_data\\M5_2792_et_timescan\\'#\\type32\\'
npy='.npz'

delayindex = np.arange(1,501)#250
timestep_arr = [500,600,700,800,900,1000,1100,1200,1300,1396,1500,1600,2000,2500,2792]
...
for file in np.arange(len(timestep_arr)):
    fileheader = 'PE_SC_Type_32i_Rg_499_delays_1114orbits_of1331_total'+str(timestep_arr[file])+'_timesteps_resorted_et'\
...
#[500,600,700,800,900,1000,1100,1200,1300,1396,1500,1600,2000,2500,2792]     
...
SCs_32_1100_endarray=np.where(SCs_32[6,1:]==0)[0][0]
SCs_32_1200_endarray=np.where(SCs_32[7,1:]==0)[0][0]
SCs_32_1300_endarray=np.where(SCs_32[8,1:]==0)[0][0]
SCs_32_1396_endarray=np.where(SCs_32[9,1:]==0)[0][0]
SCs_32_1500_endarray=np.where(SCs_32[10,1:]==0)[0][0]
SCs_32_1600_endarray=np.where(SCs_32[11,1:]==0)[0][0]
SCs_32_2000_endarray=0#np.where(SCs_32[12,1:]==0)[0][0]
SCs_32_2500_endarray=0#np.where(SCs_32[13,1:]==0)[0][0]
SCs_32_2792_endarray=0#np.where(SCs_32[14,1:]==0)[0][0]
...
plt.plot(timeindex[:SCs_32_600_endarray-1],SCs_32[1,1:SCs_32_600_endarray],color=colors[1,:],label=str(timestep_arr[1])+' timesteps')
plt.plot(timeindex[:SCs_32_700_endarray-1],SCs_32[2,1:SCs_32_700_endarray],color=colors[2,:],label=str(timestep_arr[2])+' timesteps')
plt.plot(timeindex[:SCs_32_800_endarray-1],SCs_32[3,1:SCs_32_800_endarray],color=colors[3,:],label=str(timestep_arr[3])+' timesteps')
plt.plot(timeindex[:SCs_32_900_endarray-1],SCs_32[4,1:SCs_32_900_endarray],color=colors[4,:],label=str(timestep_arr[4])+' timesteps')
plt.plot(timeindex[:SCs_32_1000_endarray-1],SCs_32[5,1:SCs_32_1000_endarray],color=colors[5,:],label=str(timestep_arr[5])+' timesteps')
plt.plot(timeindex[:SCs_32_1100_endarray-1],SCs_32[6,1:SCs_32_1100_endarray],color=colors[6,:],label=str(timestep_arr[6])+' timesteps')
plt.plot(timeindex[:SCs_32_1200_endarray-1],SCs_32[7,1:SCs_32_1200_endarray],color=colors[7,:],label=str(timestep_arr[7])+' timesteps')
plt.plot(timeindex[:SCs_32_1300_endarray-1],SCs_32[8,1:SCs_32_1300_endarray],color=colors[8,:],label=str(timestep_arr[8])+' timesteps')
plt.plot(timeindex[:SCs_32_1396_endarray-1],SCs_32[9,1:SCs_32_1396_endarray],color=colors[9,:],label=str(timestep_arr[9])+' timesteps')
plt.plot(timeindex[:SCs_32_1500_endarray-1],SCs_32[10,1:SCs_32_1500_endarray],color=colors[10,:],label=str(timestep_arr[10])+' timesteps')
plt.plot(timeindex[:SCs_32_1600_endarray-1],SCs_32[11,1:SCs_32_1600_endarray],color=colors[11,:],label=str(timestep_arr[11])+' timesteps')
plt.plot(timeindex[:SCs_32_2000_endarray-2],SCs_32[12,1:SCs_32_2000_endarray-1],color=colors[12,:],label=str(timestep_arr[12])+' timesteps')
plt.plot(timeindex[:SCs_32_2500_endarray-2],SCs_32[13,1:SCs_32_2500_endarray-1],color=colors[13,:],label=str(timestep_arr[13])+' timesteps')
plt.plot(timeindex[:SCs_32_2792_endarray-2],SCs_32[14,1:SCs_32_2792_endarray-1],color=colors[14,:],label=str(timestep_arr[14])+' timesteps')
...
savefilename='M5_SC_recordlengthvariation_type32i_et.png'
