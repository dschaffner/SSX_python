...
datadir = 'C:\\Users\\dschaffner\\Dropbox\\From OneDrive\\Galatic Dynamics Data\\GalpyData_July2018\\resorted_data\\M7_3910_et_timescan\\'#\\type32\\'
npy='.npz'

delayindex = np.arange(1,501)#250
timestep_arr = [500,750,1000,1700,1800,1900,1955,2100,2400,2450,2500,2550,2600,2650,2700,3000,3910]
...
for file in np.arange(len(timestep_arr)):
    fileheader = 'PE_SC_Type_32i_Rg_499_delays_1277orbits_of1619_total'+str(timestep_arr[file])+'_timesteps_resorted_et'\
...
#[500,750,1000,1700,1800,1900,1955,2100,2400,2450,2500,2550,2600,2650,2700,3000,3910]
...
SCs_32_1700_endarray=np.where(SCs_32[3,1:]==0)[0][0]
SCs_32_1800_endarray=np.where(SCs_32[4,1:]==0)[0][0]
SCs_32_1900_endarray=np.where(SCs_32[5,1:]==0)[0][0]
SCs_32_1955_endarray=np.where(SCs_32[6,1:]==0)[0][0]
SCs_32_2100_endarray=0#np.where(SCs_32[7,1:]==0)[0][0]
SCs_32_2400_endarray=0
SCs_32_2450_endarray=0
SCs_32_2500_endarray=0#np.where(SCs_32[8,1:]==0)[0][0]
SCs_32_2550_endarray=0
SCs_32_2600_endarray=0
SCs_32_2650_endarray=0
SCs_32_2700_endarray=0
SCs_32_3000_endarray=0#np.where(SCs_32[9,1:]==0)[0][0]
SCs_32_3910_endarray=0#np.where(SCs_32[10,1:]==0)[0][0]
...
plt.plot(timeindex[:SCs_32_750_endarray-1],SCs_32[1,1:SCs_32_750_endarray],color=colors[1,:],label=str(timestep_arr[1])+' timesteps')
plt.plot(timeindex[:SCs_32_1000_endarray-1],SCs_32[2,1:SCs_32_1000_endarray],color=colors[2,:],label=str(timestep_arr[2])+' timesteps')
plt.plot(timeindex[:SCs_32_1700_endarray-1],SCs_32[3,1:SCs_32_1700_endarray],color=colors[3,:],label=str(timestep_arr[3])+' timesteps')
plt.plot(timeindex[:SCs_32_1800_endarray-1],SCs_32[4,1:SCs_32_1800_endarray],color=colors[4,:],label=str(timestep_arr[4])+' timesteps')
plt.plot(timeindex[:SCs_32_1900_endarray-1],SCs_32[5,1:SCs_32_1900_endarray],color=colors[5,:],label=str(timestep_arr[5])+' timesteps')
plt.plot(timeindex[:SCs_32_1955_endarray-1],SCs_32[6,1:SCs_32_1955_endarray],color=colors[6,:],label=str(timestep_arr[6])+' timesteps')
plt.plot(timeindex[:SCs_32_2100_endarray-2],SCs_32[7,1:SCs_32_2100_endarray-1],color=colors[7,:],label=str(timestep_arr[7])+' timesteps')
plt.plot(timeindex[:SCs_32_2400_endarray-2],SCs_32[8,1:SCs_32_2400_endarray-1],color=colors[8,:],label=str(timestep_arr[8])+' timesteps')
plt.plot(timeindex[:SCs_32_2450_endarray-2],SCs_32[9,1:SCs_32_2450_endarray-1],color=colors[9,:],label=str(timestep_arr[9])+' timesteps')
plt.plot(timeindex[:SCs_32_2500_endarray-2],SCs_32[10,1:SCs_32_2500_endarray-1],color=colors[10,:],label=str(timestep_arr[10])+' timesteps')
plt.plot(timeindex[:SCs_32_2550_endarray-2],SCs_32[11,1:SCs_32_2550_endarray-1],color=colors[11,:],label=str(timestep_arr[11])+' timesteps')
plt.plot(timeindex[:SCs_32_2600_endarray-2],SCs_32[12,1:SCs_32_2600_endarray-1],color=colors[12,:],label=str(timestep_arr[12])+' timesteps')
plt.plot(timeindex[:SCs_32_2650_endarray-2],SCs_32[13,1:SCs_32_2650_endarray-1],color=colors[13,:],label=str(timestep_arr[13])+' timesteps')
plt.plot(timeindex[:SCs_32_2700_endarray-2],SCs_32[14,1:SCs_32_2700_endarray-1],color=colors[14,:],label=str(timestep_arr[14])+' timesteps')
plt.plot(timeindex[:SCs_32_3000_endarray-2],SCs_32[15,1:SCs_32_3000_endarray-1],color=colors[15,:],label=str(timestep_arr[15])+' timesteps')
plt.plot(timeindex[:SCs_32_3910_endarray-2],SCs_32[16,1:SCs_32_3910_endarray-1],color=colors[16,:],label=str(timestep_arr[16])+' timesteps')
...
savefilename='M7_SC_recordlengthvariation_type32i_et.png'
