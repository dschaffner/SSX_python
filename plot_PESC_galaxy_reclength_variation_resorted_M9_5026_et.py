...
datadir = 'C:\\Users\\dschaffner\\Dropbox\\From OneDrive\\Galatic Dynamics Data\\GalpyData_July2018\\resorted_data\\M9_5026_et_timescan\\'#\\type32\\'
npy='.npz'

delayindex = np.arange(1,501)#250
timestep_arr = [500,1000,2000,2100,2200,2300,2400,2513,2600,2700,3000,4000,5026]
...
for file in np.arange(len(timestep_arr)):
    fileheader = 'PE_SC_Type_32i_Rg_499_delays_556orbits_of677_total'+str(timestep_arr[file])+'_timesteps_resorted_et'\
    #fileheader = 'PE_SC_Type_32o_Rg_499_delays_56orbits_of63_total'+str(timestep_arr[file])+'_timesteps_resorted_et'
...
#[500,1000,2000,2100,2200,2300,2400,2513,2600,2700,3000,4000,5026]
...
SCs_32_2200_endarray=0#np.where(SCs_32[4,1:]==0)[0][0]
SCs_32_2300_endarray=0#np.where(SCs_32[5,1:]==0)[0][0]
SCs_32_2400_endarray=0#np.where(SCs_32[6,1:]==0)[0][0]
SCs_32_2513_endarray=0#np.where(SCs_32[7,1:]==0)[0][0]
SCs_32_2600_endarray=0#np.where(SCs_32[8,1:]==0)[0][0]
SCs_32_2700_endarray=0#np.where(SCs_32[9,1:]==0)[0][0]
SCs_32_3000_endarray=0#np.where(SCs_32[10,1:]==0)[0][0]
SCs_32_4000_endarray=0#np.where(SCs_32[10,1:]==0)[0][0]
SCs_32_5026_endarray=0#np.where(SCs_32[10,1:]==0)[0][0]
...
plt.plot(timeindex[:SCs_32_2200_endarray-2],SCs_32[4,1:SCs_32_2200_endarray-1],color=colors[4,:],label=str(timestep_arr[4])+' timesteps')
...
plt.plot(timeindex[:SCs_32_2513_endarray-2],SCs_32[7,1:SCs_32_2513_endarray-1],color=colors[7,:],label=str(timestep_arr[7])+' timesteps')
...
plt.plot(timeindex[:SCs_32_3000_endarray-2],SCs_32[10,1:SCs_32_3000_endarray-1],color=colors[10,:],label=str(timestep_arr[10])+' timesteps')
plt.plot(timeindex[:SCs_32_4000_endarray-2],SCs_32[11,1:SCs_32_4000_endarray-1],color=colors[11,:],label=str(timestep_arr[11])+' timesteps')
plt.plot(timeindex[:SCs_32_5026_endarray-2],SCs_32[12,1:SCs_32_5026_endarray-1],color=colors[12,:],label=str(timestep_arr[12])+' timesteps')
