...
datadir = 'C:\\Users\\dschaffner\\Dropbox\\From OneDrive\\Galatic Dynamics Data\\GalpyData_July2018\\resorted_data\\M8_4468_et_timescan\\'#\\type32\\'
npy='.npz'

delayindex = np.arange(1,501)#250
timestep_arr = [500,1000,2000,2100,2234,2300,2400,2500,2600,2700,2800,2900,3000,3100,3200,3300,3400,3500,3600,3700,3800,3900,4000,4468]
...
for file in np.arange(len(timestep_arr)):
    fileheader = 'PE_SC_Type_32i_Rg_499_delays_1521orbits_of1589_total'+str(timestep_arr[file])+'_timesteps_resorted_et'\
    #fileheader = 'PE_SC_Type_32o_Rg_499_delays_510orbits_of521_total'+str(timestep_arr[file])+'_timesteps_resorted_et'
...
#[500,1000,2000,2100,2234,2300,2400,2500,2600,2700,2800,2900,3000,3100,3200,3300,3400,3500,3600,3700,3800,3900,4000,4468]


SCs_32_500_endarray=np.where(SCs_32[0,1:]==0)[0][0]
SCs_32_1000_endarray=np.where(SCs_32[1,1:]==0)[0][0]
SCs_32_2000_endarray=0#np.where(SCs_32[2,1:]==0)[0][0]
SCs_32_2100_endarray=0#np.where(SCs_32[3,1:]==0)[0][0]
SCs_32_2234_endarray=0#np.where(SCs_32[4,1:]==0)[0][0]
SCs_32_2300_endarray=0#np.where(SCs_32[5,1:]==0)[0][0]
SCs_32_2400_endarray=0#np.where(SCs_32[6,1:]==0)[0][0]
SCs_32_2500_endarray=0
SCs_32_2600_endarray=0
SCs_32_2700_endarray=0
SCs_32_2800_endarray=0
SCs_32_2900_endarray=0#np.where(SCs_32[7,1:]==0)[0][0]
SCs_32_3000_endarray=0#np.where(SCs_32[8,1:]==0)[0][0]
SCs_32_3100_endarray=0
SCs_32_3200_endarray=0
SCs_32_3300_endarray=0
SCs_32_3400_endarray=0
SCs_32_3500_endarray=0
SCs_32_3600_endarray=0
SCs_32_3700_endarray=0
SCs_32_3800_endarray=0
SCs_32_3900_endarray=0
SCs_32_4000_endarray=0#np.where(SCs_32[9,1:]==0)[0][0]
SCs_32_4468_endarray=0#np.where(SCs_32[10,1:]==0)[0][0]


ax1=plt.subplot(1,1,1)
#plt.plot(timeindex[:SCs_32_500_endarray-1],SCs_32[0,1:SCs_32_500_endarray],color=colors[0,:],label=str(timestep_arr[0])+' timesteps')
#plt.plot(timeindex[:SCs_32_1000_endarray-1],SCs_32[1,1:SCs_32_1000_endarray],color=colors[1,:],label=str(timestep_arr[1])+' timesteps')
#plt.plot(timeindex[:SCs_32_2000_endarray-2],SCs_32[2,1:SCs_32_2000_endarray-1],color=colors[2,:],label=str(timestep_arr[2])+' timesteps')
#plt.plot(timeindex[:SCs_32_2100_endarray-2],SCs_32[3,1:SCs_32_2100_endarray-1],color=colors[3,:],label=str(timestep_arr[3])+' timesteps')
#plt.plot(timeindex[:SCs_32_2234_endarray-2],SCs_32[4,1:SCs_32_2234_endarray-1],color=colors[4,:],label=str(timestep_arr[4])+' timesteps')
#plt.plot(timeindex[:SCs_32_2300_endarray-2],SCs_32[5,1:SCs_32_2300_endarray-1],color=colors[5,:],label=str(timestep_arr[5])+' timesteps')
#plt.plot(timeindex[:SCs_32_2400_endarray-2],SCs_32[6,1:SCs_32_2400_endarray-1],color=colors[6,:],label=str(timestep_arr[6])+' timesteps')
#plt.plot(timeindex[:SCs_32_2500_endarray-2],SCs_32[7,1:SCs_32_2500_endarray-1],color=colors[7,:],label=str(timestep_arr[7])+' timesteps')
#plt.plot(timeindex[:SCs_32_2600_endarray-2],SCs_32[8,1:SCs_32_2600_endarray-1],color=colors[8,:],label=str(timestep_arr[8])+' timesteps')
plt.plot(timeindex[:SCs_32_2700_endarray-2],SCs_32[9,1:SCs_32_2700_endarray-1],color=colors[9,:],label=str(timestep_arr[9])+' timesteps')
plt.plot(timeindex[:SCs_32_2800_endarray-2],SCs_32[10,1:SCs_32_2800_endarray-1],color=colors[10,:],label=str(timestep_arr[10])+' timesteps')
plt.plot(timeindex[:SCs_32_2900_endarray-2],SCs_32[11,1:SCs_32_2900_endarray-1],color=colors[11,:],label=str(timestep_arr[11])+' timesteps')
plt.plot(timeindex[:SCs_32_3000_endarray-2],SCs_32[12,1:SCs_32_3000_endarray-1],color=colors[12,:],label=str(timestep_arr[12])+' timesteps')
plt.plot(timeindex[:SCs_32_3100_endarray-2],SCs_32[13,1:SCs_32_3100_endarray-1],color=colors[13,:],label=str(timestep_arr[13])+' timesteps')
plt.plot(timeindex[:SCs_32_3200_endarray-2],SCs_32[14,1:SCs_32_3200_endarray-1],color=colors[14,:],label=str(timestep_arr[14])+' timesteps')
plt.plot(timeindex[:SCs_32_3300_endarray-2],SCs_32[15,1:SCs_32_3300_endarray-1],color=colors[15,:],label=str(timestep_arr[15])+' timesteps')
plt.plot(timeindex[:SCs_32_3400_endarray-2],SCs_32[16,1:SCs_32_3400_endarray-1],color=colors[16,:],label=str(timestep_arr[16])+' timesteps')
plt.plot(timeindex[:SCs_32_3500_endarray-2],SCs_32[17,1:SCs_32_3500_endarray-1],color=colors[17,:],label=str(timestep_arr[17])+' timesteps')
plt.plot(timeindex[:SCs_32_3600_endarray-2],SCs_32[18,1:SCs_32_3600_endarray-1],color=colors[18,:],label=str(timestep_arr[18])+' timesteps')
plt.plot(timeindex[:SCs_32_3700_endarray-2],SCs_32[19,1:SCs_32_3700_endarray-1],color=colors[19,:],label=str(timestep_arr[19])+' timesteps')
plt.plot(timeindex[:SCs_32_3800_endarray-2],SCs_32[20,1:SCs_32_3800_endarray-1],color=colors[20,:],label=str(timestep_arr[20])+' timesteps')
#plt.plot(timeindex[:SCs_32_3900_endarray-2],SCs_32[21,1:SCs_32_3900_endarray-1],color=colors[21,:],label=str(timestep_arr[21])+' timesteps')
#plt.plot(timeindex[:SCs_32_4000_endarray-2],SCs_32[22,1:SCs_32_4000_endarray-1],color=colors[22,:],label=str(timestep_arr[22])+' timesteps')
#plt.plot(timeindex[:SCs_32_4468_endarray-2],SCs_32[23,1:SCs_32_4468_endarray-1],color=colors[23,:],label=str(timestep_arr[23])+' timesteps')
#plt.plot(timeindex[:SCs_32_3352_endarray-2],SCs_32[23,1:SCs_32_3352_endarray-1],color=colors[23,:],label='3352 timesteps')
...
savefilename='M8_SC_recordlengthvariation_type32i_et.png'
