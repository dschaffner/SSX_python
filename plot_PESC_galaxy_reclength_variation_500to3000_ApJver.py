...
plt.plot(normtimeindex[:SCs_32_750_endarray-1],SCs_32[1,1:SCs_32_750_endarray],color='blue',linestyle='--',markevery=(20,100),label=str(orbitdur1)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_1000_endarray-1],SCs_32[2,1:SCs_32_1000_endarray],color='red',linestyle='-.',label=str(orbitdur2)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_1676_endarray-1],SCs_32[13,1:SCs_32_1676_endarray],color='green',linestyle=':',label=str(orbitdur3)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_2000_endarray-1],SCs_32[18,1:SCs_32_2000_endarray],color='orange',linestyle='-',label=str(orbitdur4)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_32_3352_endarray-1],SCs_32[23,1:SCs_32_3352_endarray],color='purple',linestyle='None',marker='o',markevery=3,label=str(orbitdur5)+r' $\tau_{dyn}^{M6}$')
...
plt.xticks(normtimearray,fontsize=12)
plt.xlabel(r'$\tau_s/T_{dyn}$',fontsize=15)
ax1.set_xticklabels([])
plt.title(r'Type 3$\rightarrow$2i - M6',fontsize=15)
...
plt.plot(normtimeindex[:SCs_32_750_endarray-1],PEs_32[1,1:SCs_32_750_endarray],color='blue',linestyle='--',label=str(orbitdur1)+r' $\tau_{dyn}$')
plt.plot(normtimeindex[:SCs_32_1000_endarray-1],PEs_32[2,1:SCs_32_1000_endarray],color='red',linestyle='-.',label=str(orbitdur2)+r' $\tau_{dyn}$')
plt.plot(normtimeindex[:SCs_32_1676_endarray-1],PEs_32[13,1:SCs_32_1676_endarray],color='green',linestyle=':',label=str(orbitdur3)+r' $\tau_{dyn}$')
plt.plot(normtimeindex[:SCs_32_2000_endarray-1],PEs_32[18,1:SCs_32_2000_endarray],color='orange',linestyle='-',label=str(orbitdur4)+r' $\tau_{dyn}$')
plt.plot(normtimeindex[:SCs_32_3352_endarray-1],PEs_32[23,1:SCs_32_3352_endarray],color='purple',linestyle='None',marker='o',markevery=3,label=str(orbitdur5)+r' $\tau_{dyn}$')

#plt.xticks(timearray,timelist,fontsize=12)
#plt.xticks(normtimearray,list(np.round(normtimearray,2)),fontsize=12)
#plt.xticks(normtimearray,list(np.round(normtimearray,2)),fontsize=12)
plt.xticks(np.array([0.0,0.05,0.1,0.15,0.2,0.25,0.3]),[0.0,0.05,0.10,0.15,0.20,0.25,0.30],fontsize=12)
...
#savefilename='SC_and_PE_recordlengthvariation_M6_type32i_normdyntime_ApJver.png'
savefilename='SC_and_PE_recordlengthvariation_M6_type32i_normdyntime_ApJver.eps'
...
ax1=plt.subplot(2,1,1)
plt.plot(normtimeindex[:SCs_1_750_endarray-1],SCs_1[0,1:SCs_1_750_endarray],color='blue',linestyle='--',markevery=(20,100),label=str(orbitdur1)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1000_endarray-1],SCs_1[1,1:SCs_1_1000_endarray],color='red',linestyle='-.',label=str(orbitdur2)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1676_endarray-1],SCs_1[2,1:SCs_1_1676_endarray],color='green',linestyle=':',label=str(orbitdur3)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_2000_endarray-1],SCs_1[3,1:SCs_1_2000_endarray],color='orange',linestyle='-',label=str(orbitdur4)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_3352_endarray-1],SCs_1[4,1:SCs_1_3352_endarray],color='purple',linestyle='None',marker='o',markevery=3,label=str(orbitdur5)+r' $\tau_{dyn}^{M6}$')
...
#plt.xticks(timearray,timelist,fontsize=12)
plt.xticks(normtimearray,fontsize=12)
plt.xlabel(r'$\tau_s/T^{M6}_{dyn}$',fontsize=15)
ax1.set_xticklabels([])
...
ax2=plt.subplot(2,1,2)
#plt.plot(timeindex[:SCs_32_500_endarray-1],PEs_32[0,1:SCs_32_500_endarray],color=colors[0,:],label='50 Myr')
plt.plot(normtimeindex[:SCs_1_750_endarray-1],PEs_1[0,1:SCs_1_750_endarray],color='blue',linestyle='--',label=str(orbitdur1)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1000_endarray-1],PEs_1[1,1:SCs_1_1000_endarray],color='red',linestyle='-.',label=str(orbitdur2)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_1676_endarray-1],PEs_1[2,1:SCs_1_1676_endarray],color='green',linestyle=':',label=str(orbitdur3)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_2000_endarray-1],PEs_1[3,1:SCs_1_2000_endarray],color='orange',linestyle='-',label=str(orbitdur4)+r' $\tau_{dyn}^{M6}$')
plt.plot(normtimeindex[:SCs_1_3352_endarray-1],PEs_1[4,1:SCs_1_3352_endarray],color='purple',linestyle='None',marker='o',markevery=3,label=str(orbitdur5)+r' $\tau_{dyn}^{M6}$')
...
#savefilename='SC_and_PE_recordlengthvariation_M6_type1_normdyntime_ApJver.png'
savefilename='SC_and_PE_recordlengthvariation_M6_type1_normdyntime_ApJver.eps'
savefile = os.path.normpath(datadir+savefilename)
plt.savefig(savefile,dpi=600,facecolor='w',edgecolor='k')
plt.clf()
plt.close()
