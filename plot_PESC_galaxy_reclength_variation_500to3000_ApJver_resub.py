...
plt.plot(normpatterntime[:SCs_32_750_endarray-1],PEs_32[1,1:SCs_32_750_endarray],color=colors[0,:],linestyle='solid',label=r'$T^{M6e}_{dyn}=$'+str(orbitdur1))
plt.plot(normpatterntime[:SCs_32_1000_endarray-1],PEs_32[2,1:SCs_32_1000_endarray],color=colors[1,:],linestyle='solid',label=r'$T^{M6e}_{dyn}=$'+str(orbitdur2))
plt.plot(normpatterntime[:SCs_32_1676_endarray-1],PEs_32[13,1:SCs_32_1676_endarray],color=colors[2,:],linestyle='solid',label=r'$T^{M6e}_{dyn}=$'+str(orbitdur3))
plt.plot(normpatterntime[:SCs_32_2000_endarray-1],PEs_32[18,1:SCs_32_2000_endarray],color=colors[3,:],linestyle='solid',label=r'$T^{M6e}_{dyn}=$'+str(orbitdur4))
plt.plot(normpatterntime[:SCs_32_3352_endarray-1],PEs_32[23,1:SCs_32_3352_endarray],color=colors[4,:],linestyle='solid',label=r'$T^{M6e}_{dyn}=$'+str(orbitdur5))
